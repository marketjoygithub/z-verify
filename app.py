...
@app.route('/')
def main():
	return 'Welcome at email verifier just provide /up/emailid at address bar to verify  for example http://singhamit07.pythonanywhere.com/up/a@saleszip.com'

@app.route('/up/<string:email>',methods=['GET','POST'])
def post(email):
